...
public class QuestionList extends Fragment{
    ...
    private void init(){
        ...
        setListener();
        m_Dialog = ProgressDialog.show(getActivity(), "请等待...", "正在载入未解决问题...",
                true);
    ...
    private void setListAdapter() {
        mAdapter=new QuestionItemAdapter(mQuestionList,getActivity());
        Log.e("index=", index + "");
    ...
    Runnable runnable = new Runnable() {
        @Override
        public void run() {
            mQuestionList = QuestionsNetUtil.getUnanseredQuestion(0, index + 1,
                    1);
